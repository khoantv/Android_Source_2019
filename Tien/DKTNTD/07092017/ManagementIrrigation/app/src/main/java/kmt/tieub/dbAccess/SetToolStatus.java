...
public class SetToolStatus extends AsyncTask<String, Void, String> {

    private Exception exception;
    private Context mContext;

    public SetToolStatus(Context mContext)
    {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            if (result.trim().equals("OK"))
                Toast.makeText(mContext, "Updated Tool Status!", Toast.LENGTH_SHORT).show();
        }
        catch (Exception ex)
        {
    ...
    public String  performPostCall(boolean statusTb1, boolean statusTb2, boolean statusTb3) {
        ...
        try {
            ...
            String requestURL = "http://ais.tnut.edu.vn/Android/updateToolStatus";
